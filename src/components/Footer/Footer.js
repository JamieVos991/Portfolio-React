            ...
            <div className="footer__upper">
                <div className="footer__info">
                    <div className="footer__circle" >
                        <i class="footer__icons fa-solid fa-phone"></i>
                        <p className="footer__p">+31 6 13896402</p>
                    </div>
                    <div className="footer__circle">
                        <i class="footer__icons fa-solid fa-envelope"></i>
                        <p className="footer__p">Jamievos100@gmail.com</p>
                    </div>
                    <div className="footer__circle">
                        <i class="footer__icons fa-brands fa-github"></i>
                        <p className="footer__p" href="https://github.com/JamieVos991">JamieVos991</p>  
